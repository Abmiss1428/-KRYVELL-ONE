const CACHE='kryvell-os-v0.5.0';
const SHELL=['/','/index.html','/kryvell-os.css','/kryvell-os.js','/nyxcore-life.js','/nyxcore-hybrid.js','/fusion-core.css','/fusion-core.js','/boot-fallback.js','/manifest.webmanifest','/kryvell-icon.svg','/kryvell-one.html','/styles.css','/app.js','/owner-session.js','/owner-session.css','/phone-auth.js','/phone-auth.css','/data-core-client.js','/nexcreate-plan.js'];
