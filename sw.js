const CACHE='kryvell-os-v0.8.10';
const CORE=['/','/index.html','/kryvell-os.css','/kryvell-os.js','/nyxcore-loader.js','/nyxcore-fastboot.js','/fusion-core.css','/fusion-core.js','/agentic-core.css','/agentic-core.js','/boot-fallback.js','/manifest.webmanifest','/kryvell-icon.svg','/phone-auth.js','/phone-auth.css','/data-core-client.js','/nyxcore-safe.html'];
