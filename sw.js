const CACHE='kryvell-os-v0.8.2';
const CORE=['/','/index.html','/kryvell-os.css','/kryvell-os.js','/nyxcore-loader.js','/fusion-core.css','/fusion-core.js','/boot-fallback.js','/manifest.webmanifest','/kryvell-icon.svg','/phone-auth.js','/phone-auth.css','/data-core-client.js','/nyxcore-safe.html'];
