const CACHE='kryvell-os-v0.1.0';
const SHELL=['/','/index.html','/kryvell-os.css','/kryvell-os.js','/manifest.webmanifest','/kryvell-icon.svg','/kryvell-one.html','/styles.css','/app.js','/owner-session.js','/owner-session.css','/nexcreate-plan.js'];
