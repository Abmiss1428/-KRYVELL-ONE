const APPS={
  ...
  nyxcore:{name:'NYXCORE',badge:'NYX',desc:'Écosystème de vie artificielle local : ADN, énergie, reproduction, pooling, PocketPal et lignées.',mode:'iframe',url:'/nyxcore-safe.html?v=0.8.7'},
