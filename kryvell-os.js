const APPS={
  ...
  nyxcore:{name:'NYXCORE',badge:'NYX',desc:'Écosystème de vie artificielle local : ADN, énergie, reproduction, pooling, PocketPal et lignées.',mode:'nyxcore',url:'/nyxcore-safe.html?v=0.8.9'},
...
function openApp(appKey){
  ...
  if(app.mode==='nyxcore'){
    ...
    if(window.KryvellNyxcore?.render){
      ...
      mount.innerHTML='<div class="window-placeholder"><h2>NYXCORE</h2><p>Le moteur local ne répond pas encore.</p><div class="window-links"><a href="/nyxcore-safe.html?v=0.8.9">OUVRIR ACCÈS DIRECT</a></div></div>';
    }
    return;
  }
  if(app.mode==='health'){
